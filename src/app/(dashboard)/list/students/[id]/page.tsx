        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="bg-rubixSky p-6 rounded-[2rem] flex-1 flex flex-col sm:flex-row gap-6 shadow-sm border border-sky-200/50">
            ...
            <div className="w-full sm:w-2/3 flex flex-col justify-center">
              ...
              <div className="flex items-center gap-3 mb-2 flex-wrap">
                ...
                {role === "admin" && (
                  <>
                    ...
                    <Link
                      href={`/list/students/admission-slip/${student.id}`}
                      target="_blank"
                      className="px-4 py-2 rounded-lg bg-rubixPurple text-white text-sm font-semibold hover:opacity-90"
                    >
              ...
              <div className="inline-flex items-center mt-2 mb-3 px-3 py-1 rounded-full bg-white border border-rubixPurple/20">

                <span className="text-xs font-semibold text-slate-500 mr-2">
                  Admission No.
                </span>

                <span className="font-mono text-sm font-bold text-rubixPurple">
