...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 1, 18, 8, 0),
    end: new Date(2026, 1, 18, 8, 45),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 1, 16, 11, 0),
    end: new Date(2026, 1, 16, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 1, 18, 13, 0),
    end: new Date(2026, 1, 18, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 1, 16, 12, 0),
    end: new Date(2026, 1, 16, 12, 45),
  },
  {
    title: "English",
    allDay: false,
...

  {
    title: "History",
    allDay: false,
    start: new Date(2026, 1, 20, 11, 0),
    end: new Date(2026, 1, 20, 11, 45),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 1, 16, 14, 0),
    end: new Date(2026, 1, 16, 15, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 1, 16, 10, 0),
    end: new Date(2026, 1, 16, 10, 45),
  },

  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 1, 20, 12, 0),
    end: new Date(2026, 1, 20, 12, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 1, 18, 14, 0),
    end: new Date(2026, 1, 18, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 1, 19, 9, 0),
    end: new Date(2026, 1, 19, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 1, 18, 10, 0),
    end: new Date(2026, 1, 18, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 1, 20, 15, 0),
    end: new Date(2026, 1, 20, 15, 45),
  },
  ...
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 1, 19, 12, 0),
    end: new Date(2026, 1, 19, 12, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 1, 16, 9, 0),
    end: new Date(2026, 1, 16, 9, 45),
  },
  ...
  },
  {
    ...
    end: new Date(2026, 1, 17, 9, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 1, 19, 12, 0),
    end: new Date(20246, 1, 19, 13, 45),
  },
];